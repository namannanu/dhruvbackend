...
router
  .route('/me/applications/:applicationId/withdraw')
  .patch(restrictTo('worker'), controller.withdrawApplication)
  .post(restrictTo('worker'), controller.withdrawApplication);
...
router
  .route('/:workerId/applications/:applicationId/withdraw')
  .patch(restrictTo('worker'), controller.withdrawApplication)
  .post(restrictTo('worker'), controller.withdrawApplication);
